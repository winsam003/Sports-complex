            ...
            <div className='RentalInfoSearchButton_Conditions_div'>
                ...
                <div className='RentalInfoSearchButton_scrollbox'>
                    <pre>
                        ...
                        3. "전용사용"이란 체육시설의 전체 또는 일부를 일정기간(시간) 동안 사용하는 것을 말하며 "전용사용료"란 전용사용자가 납부하는 요금을 말한다.<br></br>
                        ...
                        ②체육시설을 전용으로 사용하고자 하는 사람은 사용자의 주소, 성명, 사용할 시설, 사용목적, 사용기간 및 시간, 징수하려는 관람료액을 명시하여<br></br> 신청하여야 하며 사용기간을 초과하여 사용할 때도 허가를 받아야 한다.<br></br>
                        ...
                        ③시장은 개방하고자 하는 체육시설에 주민이 이용할 수 있는 기본적인 운동기구를 배치하여야 하며 제2항의 각 호 내용을 주민이 쉽게볼 수 있는<br></br> 장소에 게시하여야 한다.<br></br>
                        ...
                        제11조 (초과사용료 등)사용자가 사용허가시간을 초과하여 체육시설 및 부속시설을 사용할 때에는 다음 각 호의 초과사용료를 납부하여야 한다.<br></br> 이 경우 초과사용시간이 1시간 미만일 때는 1시간으로 본다.<br></br>
                        ...
                        바. 성남시체육회 가맹단체 및 성남시생활체육회에 등록된 단체의 시장(구청장), 시의회 의장, 시 생활체육회장, 협회장(연합회장)기 대회(연 1회)<br></br>
                        사. 도 및 시(또는 소속체육회)에서 주관하는 저소득 한부모가족, 국민기초생활보장수급자, 보훈대상자, 장애인, 어린이, 경로자, 군인을<br></br> 대상으로 하는 경기·행사<br></br>
                        ...
                        4. 천재지변과 우천 등 기상상황으로 사용이 불가능하여 사용자가 사전에 허가반납 요청을 할 때와 시의 긴박한 사정으로 사용의 취소를 한 때에는<br></br> 사용료 전액<br></br>
                        ...
                        제14조 (입장권)<br></br>
                        ①시장은 관람권을 발행하지 아니하는 행사·경기를 관람하거나 행사·경기의 관람이 아닌 관광 등의 목적으로 입장하는 때에는 입장권을 발행할<br></br> 수 있다. 다만, 다음 각 호의 어느 하나에 해당할 때에는 입장권 없이 입장할 수 있다.<br></br>
                        ...
                        ②제1항의 입장료는 500원 이상으로 한다.<br></br> 다만, 다음 각 호의 어느 하나에 해당하는 사람은 200원으로 한다.<br></br>
                        1. 만12세 이하인 사람, 만 65세 이상의 사람으로서 주민등록증(주민등록증이 없는 경우에는 관공서 또는 공공기관이 발행한 증명서로서 사진이<br></br> 첨부되어 본인임을 확인할 수 있는 여권ㆍ운전면허증 등)을 휴대한 사람, 「장애인복지법」에 따른 장애인, 「국가유공자 등 예우 및 지원에 관한<br></br> 법률」에 따른 국가유공자, 그 밖에 관련법에 따른 유공자<br></br>
                        ...
                        ③시장은 제1항 및 제2항에 따라 사용자의 의무를 담보하기 위하여 체육시설의 사용을 허가하는 때에는 시설물 등의 원상복구를 위한 비용이나<br></br> 폐기물 등의 수거에 필요한 비용을 사전에 예치하게 하거나 청소용역업체 등과의 용역계약서를 제출하게 하는 등 필요한 조치를 할 수 있다.<br></br>
                        ④ 사용자는 자신의 행위 또는 자신이 주관하는 행사 및 경기로 인하여 발생한 사고에 대하여 모든 책임을 진다.<br></br>
                        제19조 (사회체육지도자의 배치)시장은 체육시설의 사용 및 이용자에 대한 경기규칙 및 체육활동 전반에 대한 지도를 위하여 사회체육지도자를<br></br> 배치할 수 있다.<br></br>
                        ...
                        ②제1항에 따라 사용수익허가를 하는 때에는 사용료산정 등에 관하여는 「공유재산 및 물품관리법」 및 「성남시 공유재산 관리 조례」에 따르며,<br></br> 전기 및 상·하수도·청소요금 등 부대사용료는 별도 징수하여야 한다.<br></br>
                        제23조 (위탁관리)<br></br>
                        ①시장은 체육시설의 효율적인 관리 및 활용이 필요하다고 인정할 때에는 지역 사회 체육의 활성화에 이바지할 수 있는 체육단체, 생활체육단체,<br></br> 성남도시개발공사에 체육시설의 운영을 위탁할 수 있다.<br></br>
                        ②제1항에 따라 체육단체 및 생활체육단체에게 위탁하고자 할 때에는 「성남시 사무의 민간위탁 촉진 및 관리 조례」를 준용한다.<br></br>
                        ③제1항에 따라 위탁관리·운영하고자 할 때에는 관리책임, 위탁기간, 그 밖의 관리운영에 관한 필요한 사항에 대하여 계약을 체결하고 계약내용은<br></br> 공증을 하여야 한다.<br></br>
                        ...
                        제25조 (지휘·감독)<br></br>
                        ①시장은 수탁기관으로 하여금 관리운영에 관한 사항을 연 1회 보고하게 하며, 필요한 경우 관리·운영에 관한 사항을 검사하거나 조사할 수 있다.<br></br>
                        ...
                        ①&lt;시행일&gt; 이 조례는 공포한 날로부터 시행한다.<br></br>
                        ②&lt;사용허가 및 사용료에 관한 경과조치&gt; 이 조례 시행전에 종전의 규정에 의하여 사용허가를 받았거나 사용허가를 신청한 것에 대한 사용료의<br></br> 부과·징수는 종전의 규정에 의한다.<br></br>
                        ...
                        ②(사용허가 및 사용료에 관한 경과조치) 이 조례 시행전에 종전의 규정에 의하여 사용허가를 받았거나 사용허가를 신청한 것에 대하여는 종전의<br></br> 규정에 의한다.<br></br> 다만, 종전의 규정이 개정규정에 비하여 이용자에게 불리한 경우에는 개정규정에 의한다.<br></br>
                        ...
                        제1조(시행일) 이 조례는 공포한 날부터 시행한다.<br></br>
                        제2조(사용허가 및 사용료에 관한 경과조치) 이 조례 시행 전에 종전의 규정에 따라서 사용허가를 받았거나 사용허가를 신청한 것에 대한 사용료의<br></br> 부과징수는 종전의 규정에 따른다.
                    </pre>
                </div>
            </div>
