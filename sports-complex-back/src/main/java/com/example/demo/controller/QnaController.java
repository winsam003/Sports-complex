...
//	public ResponseEntity<?> qnaReplyInsert(@RequestBody Map<String, Object> qnaReplyData) {
		System.out.println("dto확인중입니다 여기는 컨트롤러 : " + dto);
//		Qna.builder().stfid(qnaReplyData.get("stfid"));
